...
namespace Bracket
{
    public class BracketParameters
    {
        ...
        //{
        //    get => _parameters.Find(x => x.Name.Equals(name));
        //    set
        //    {
        //        _parameters.Find(x => x.Name.Equals(name)).Value = value.Value;
        //        switch (name)
        //        {
        //            case ParameterName.OuterTubeDiameter:
        //                {
        ...
        //                    //_parameters.Find(x => x.Name.Equals(name)).Min = min;
        //                    double maxMountingHoleDiameter =
        //                        value.Value - _parameters.Find(x => x.Name.Equals(ParameterName.HoleHeight)).Value - 5 + 3;
        //                    maxMountingHoleDiameter = maxMountingHoleDiameter > 12 ? 12 : maxMountingHoleDiameter;
        ...
        //                    //_parameters.Find(x => x.Name.Equals(name)).Max = max;
        //                    double minSideWallHeight =
        //                        _parameters.Find(x => x.Name.Equals(ParameterName.MountingHoleDiameter)).Value / 2 + value.Value + 5;
        //                    minSideWallHeight = minSideWallHeight < 20 ? 20 : minSideWallHeight;

        //                    double maxMountingHoleDiameter =
        //                        _parameters.Find(x => x.Name.Equals(ParameterName.SideWallHeight)).Value - value.Value - 5 + 3;
        //                    maxMountingHoleDiameter = maxMountingHoleDiameter > 12 ? 12 : maxMountingHoleDiameter;
        ...
        //                    //_parameters.Find(x => x.Name.Equals(name)).Max = max;
        //                    double minSideWallHeight =
        //                       _parameters.Find(x => x.Name.Equals(ParameterName.HoleHeight)).Value + value.Value / 2 + 5;
        //                    minSideWallHeight = minSideWallHeight < 20 ? 20 : minSideWallHeight;

        //                    double maxHoleHeight =
        //                        _parameters.Find(x => x.Name.Equals(ParameterName.SideWallHeight)).Value - value.Value / 2 - 5;
        //                    maxHoleHeight = maxHoleHeight > 15 ? 15 : maxHoleHeight;

        //                    double minHoleHeight = value.Value / 2 + 3;
        //                    minHoleHeight = minHoleHeight > 7 ? minHoleHeight : 7;
